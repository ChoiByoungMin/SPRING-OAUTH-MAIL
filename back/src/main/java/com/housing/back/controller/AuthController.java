...
public class AuthController {
    ...
    public ResponseEntity<? super CheckCertificationResponseDto> checkCertification(
            @RequestBody @Valid CheckCertificationRequestDto requesstBody) {

        ResponseEntity<? super CheckCertificationResponseDto> response = authService.checkCertification(requesstBody);
        return response;
    }
    ...
    public ResponseEntity<? super SignUpResponseDto> signUp(
        ...
        ResponseEntity<? super SignUpResponseDto> response = authService.sigUp(requestBody);
        return response;
